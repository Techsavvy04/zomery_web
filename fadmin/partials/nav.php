                                        ...
                                        <ul class="nav-main">
                                            ...
                                            <li class="nav-main-item">
                                                <a class="nav-main-link" href="./set_comments.php">
                                                    ...
                                                    <span class="nav-main-link-name"><b>Quản lý Key</b></span>
                                                </a>
                                            </li>
                                            <li class="nav-main-item">
                                                <a class="nav-main-link" href="./set_comments.php">
                                                    <i class="nav-main-link-icon fa fa-comments"></i>
                                                    <span class="nav-main-link-name"><b>Quản lý comments</b></span>
                                                </a>
                                            </li>
                                            <li class="nav-main-item">
                                                <a class="nav-main-link" href="./set_user.php">
                                                    <i class="nav-main-link-icon fa fa-users"></i>
                                                    <span class="nav-main-link-name"><b>Quản lý người dùng</b></span>
                                                </a>
                                            </li>
                                            <li class="nav-main-item">
                                                <a class="nav-main-link" href="./set_loveday.php">
                                                    <i class="nav-main-link-icon fa fa-heart"></i>
                                                    <span class="nav-main-link-name"><b>Chỉnh sửa hẹn hò</b></span>
                                                </a>
                                            </li>
                                                ...
                                                <ul class="nav-main-submenu">
                                                    ...
                                                    <li class="nav-main-item">
                                                        <a class="nav-main-link" data-pjax href="./set_account.php">
                                                            <span class="nav-main-link-name">Quản lý cài đặt tài khoản</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-main-item">
                                                        <a class="nav-main-link" data-pjax href="./list_blackip.php">
                                                            <span class="nav-main-link-name">Danh sách blackip bị cấm</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="nav-main-item">
                                                <a class="nav-main-link" href="./logout.php?logout=1" onclick="return confirm('Bạn có chắc chắn bạn muốn thoát?')">
                                                    <i class="nav-main-link-icon fa fa-sign-out"></i>
                                                    <span class="nav-main-link-name"><b>Đăng xuất</b></span>
                                                </a>
                                            </li>
                                            <li class="nav-main-heading text-center">- Hãy theo dõi để biết thêm các tính năng -</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown d-inline-block ms-2">
                        <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle" src="<?=$avatar?>" alt="Header Avatar" style="width: 25px;height:25px;object-fit:cover;">
                            <span class="d-none d-sm-inline-block ms-2"><?=$taikhoan?></span>
                            <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block opacity-50 ms-1 mt-1"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
                            <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                                <img class="img-avatar img-avatar48 img-avatar-thumb" style="object-fit:cover;" src="<?=$avatar?>" alt="">
                            ...
                            <div class="p-2">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item d-flex align-items-center justify-content-between space-x-1" href="./logout.php?status=1" onclick="return confirm('Bạn có chắc chắn bạn muốn thoát?')">
                                    <span>Đăng xuất</span>
